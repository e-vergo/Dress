...
- **CLI (`extract_blueprint quickstart`)**: Scaffolds an existing Lean project into an SBS blueprint project -- generates optional `runway.json` for CI/CD, `blueprint.tex`, CI workflow, and injects `import Dress` into source files
